...
public class Ti_Ying_Activity extends AppCompatActivity {
   ...
   //     initData();
        mFanHui.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             startActivity(new Intent(Ti_Ying_Activity.this, HomeActivity.class));
        ...
        new HttpClient.Buidler()
                ...
                .enqueue(new RefitCallBack<Ti_Zheng_Bean>() {
                    ...
                    public void onSucess(Ti_Zheng_Bean zheng_bean) {
                        ...
                        //适配器
                        Ti_Zheng_Adapter ti_zheng_adapter = new Ti_Zheng_Adapter(u_type, Ti_Ying_Activity.this);
                        mRecy.setAdapter(ti_zheng_adapter);
                        ti_zheng_adapter.setMyClick(new Ti_Zheng_Adapter.MyClick() {
                            @Override
        ...
        new HttpClient.Buidler()
                ...
                .enqueue(new RefitCallBack<Ti_Ying_Bean>() {
                    ...
                    public void onSucess(Ti_Ying_Bean ti_ying_beans) {
                        ...
                        //适配器
                        Ti_Ying_Adapter ti_ying_adapter = new Ti_Ying_Adapter(u_type, Ti_Ying_Activity.this);
                        mRecy.setAdapter(ti_ying_adapter);
                      ti_ying_adapter.setMyClick(new Ti_Ying_Adapter.MyClick() {
                          @Override
                          public void onItemClick(int position) {
                              Intent intent = new Intent(Ti_Ying_Activity.this, Ti_Ying_RecyActivity.class);
                              intent.putExtra("position",position );
                              startActivity(intent);
                          }
                      });
