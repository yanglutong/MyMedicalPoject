 ...
 */
public class DuoAdapter<se> extends BaseAdapter<Integer> {


    public DuoAdapter(List<Integer> datas, Context context, int layoutId) {
    ...
    private DuoAdapter.SetButtonClick setonClick;

    public void SetButtonClick(DuoAdapter.SetButtonClick setonClick){
