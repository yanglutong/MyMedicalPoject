...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fl_main = (ConstraintLayout) findViewById(R.id.activity_popup);
    ...
    private void initPopupWindow() {
        ...
        window=new CommonPopupWindow(this, R.layout.layout_choose_address_dialog, ViewGroup.LayoutParams.MATCH_PARENT, (int) (screenHeight*0.5)) {
            ...
            protected void initView() {
                ...
                ll_3.setOnClickListener(MainActivity.this);
                ll_2.setOnClickListener(MainActivity.this);
                ll_1.setOnClickListener(MainActivity.this);
                ll_4.setOnClickListener(MainActivity.this);
                ...
                adapter=new ChooseAddressAdapter(MainActivity.this,list5);
...
//                        id1=cityList.get(pos).id;
                ...
                iv_close.setOnClickListener(MainActivity.this);
            }
